...
namespace Veldrid.NeoDemo.Objects
{
    internal class ScreenDuplicator : Renderable
    {
        ...
        public override void CreateDeviceObjects(GraphicsDevice gd, CommandList cl, SceneContext sc)
        {
            ...
            var blend = BlendAttachmentDescription.OVERRIDE_BLEND;
            ...
            GraphicsPipelineDescription pd = new GraphicsPipelineDescription(
                new BlendStateDescription(
                    RgbaFloat.BLACK,
                    blend, blend),
                gd.IsDepthRangeZeroToOne ? DepthStencilStateDescription.DEPTH_ONLY_LESS_EQUAL : DepthStencilStateDescription.DEPTH_ONLY_LESS_EQUAL,
