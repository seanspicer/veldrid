...
namespace Veldrid.NeoDemo.Objects
{
    public class TexturedMesh : CullRenderable
    {
        ...
        public unsafe override void CreateDeviceObjects(GraphicsDevice gd, CommandList cl, SceneContext sc)
        {
            ...
            {
                _texture = disposeFactory.CreateTexture(TextureDescription.Texture2D(1, 1, 1, 1, PixelFormat.R8G8B8A8UNorm, TextureUsage.Sampled));
            ...
            BlendStateDescription alphaBlendDesc = BlendStateDescription.SINGLE_ALPHA_BLEND;
            alphaBlendDesc.AlphaToCoverageEnabled = true;

            GraphicsPipelineDescription mainPD = new GraphicsPipelineDescription(
                _alphamapTexture != null ? alphaBlendDesc : BlendStateDescription.SINGLE_OVERRIDE_BLEND,
                gd.IsDepthRangeZeroToOne ? DepthStencilStateDescription.DEPTH_ONLY_GREATER_EQUAL : DepthStencilStateDescription.DEPTH_ONLY_LESS_EQUAL,
                RasterizerStateDescription.DEFAULT,
                PrimitiveTopology.TriangleList,
