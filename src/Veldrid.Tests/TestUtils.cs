...
namespace Veldrid.Tests
{
    public static class TestUtils
    {
        ...
        public static void CreateVulkanDeviceWithSwapchain(out Sdl2Window window, out GraphicsDevice gd)
        {
            ...
            GraphicsDeviceOptions options = new GraphicsDeviceOptions(true, PixelFormat.R16UNorm, false);
        ...
        public static void CreateMetalDeviceWithSwapchain(out Sdl2Window window, out GraphicsDevice gd)
        {
            ...
            GraphicsDeviceOptions options = new GraphicsDeviceOptions(true, PixelFormat.R16UNorm, false, ResourceBindingModel.Improved);
