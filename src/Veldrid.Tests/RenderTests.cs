...
namespace Veldrid.Tests
{
    ...
    {
        [Fact]
        public void PointsWithUIntColor()
        {
            Texture target = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            Texture staging = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.Staging));
            ...
            foreach (UIntVertexAttribsVertex vertex in vertices)
            {
                ...
                RgbaFloat expectedColor = new RgbaFloat(
                    vertex.ColorInt.X / (float)colorNormalizationFactor,
                    vertex.ColorInt.Y / (float)colorNormalizationFactor,
                    vertex.ColorInt.Z / (float)colorNormalizationFactor,
                    1);
        ...
        [Fact]
        public void PointsWithUShortNormColor()
        {
            Texture target = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            Texture staging = RF.CreateTexture(TextureDescription.Texture2D(
            ...
            ShaderSetDescription shaderSet = new ShaderSetDescription(
                new VertexLayoutDescription[]
                {
                    new VertexLayoutDescription(
                        new VertexElementDescription("Position", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float2),
                        new VertexElementDescription("Color", VertexElementSemantic.TextureCoordinate, VertexElementFormat.UShort4Norm))
                },
            ...
            VertexCPUUShortNorm[] vertices = new VertexCPUUShortNorm[]
            {
                new VertexCPUUShortNorm
                {
                    Position = new Vector2(0.5f, 0.5f),
                    R = UShortNorm(0.25f),
                    G = UShortNorm(0.5f),
            ...
            DeviceBuffer vb = RF.CreateBuffer(
                new BufferDescription((uint)(Unsafe.SizeOf<VertexCPUUShortNorm>() * vertices.Length), BufferUsage.VertexBuffer));
            GD.UpdateBuffer(vb, 0, vertices);
            ...
            foreach (VertexCPUUShortNorm vertex in vertices)
            {
                uint x = (uint)vertex.Position.X;
                uint y = (uint)vertex.Position.Y;
                if (!GD.IsUvOriginTopLeft || GD.IsClipSpaceYInverted)
        ...
        public struct VertexCPUUShortNorm
        {
            public Vector2 Position;
            public ushort R;
            public ushort G;
        ...
        [Fact]
        public void PointsWithUShortColor()
        {
            Texture target = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            Texture staging = RF.CreateTexture(TextureDescription.Texture2D(
            ...
            ShaderSetDescription shaderSet = new ShaderSetDescription(
                new VertexLayoutDescription[]
                {
                    new VertexLayoutDescription(
                        new VertexElementDescription("Position", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float2),
                        new VertexElementDescription("ColorUInt", VertexElementSemantic.TextureCoordinate, VertexElementFormat.UShort4))
                },
            ...
            VertexCPUUShort[] vertices = new VertexCPUUShort[]
            {
                new VertexCPUUShort
                {
                    Position = new Vector2(0.5f, 0.5f),
            ...
            foreach (VertexCPUUShort vertex in vertices)
            {
                uint x = (uint)vertex.Position.X;
                uint y = (uint)vertex.Position.Y;
                if (!GD.IsUvOriginTopLeft || GD.IsClipSpaceYInverted)
        ...
        [Fact]
        public void PointsWithFloat16Color()
        {
            Texture target = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            Texture staging = RF.CreateTexture(TextureDescription.Texture2D(
            ...
            ShaderSetDescription shaderSet = new ShaderSetDescription(
                new VertexLayoutDescription[]
                {
                    new VertexLayoutDescription(
                        new VertexElementDescription("Position", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float2),
                        new VertexElementDescription("ColorHalf", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Half4))
                },
            ...
            const ushort f16375 = 0x5DDC; // 375.0
            const ushort f16500 = 0x5FD0; // 500.0
            const ushort f16625 = 0x60E2; // 625.0
            const ushort f16875 = 0x62D6; // 875.0
            const ushort f161250 = 0x64E2; // 1250.0
            const ushort f161875 = 0x6753; // 1875.0
            ...
            {
                VertexCPUUShort vertex = vertices[i];
                uint x = (uint)vertex.Position.X;
                uint y = (uint)vertex.Position.Y;
                if (!GD.IsUvOriginTopLeft || GD.IsClipSpaceYInverted)
                {
        ...
        [InlineData(true)]
        [Theory]
        public unsafe void PointsWithTextureUpdateUnrelated(bool useTextureView)
        {
            ...
            Texture sampledTexture = RF.CreateTexture(
                TextureDescription.Texture2D(1, 1, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.Sampled));
        ...
        public void ComputeGeneratedVertices()
        {
            ...
            Texture output = RF.CreateTexture(
                TextureDescription.Texture2D(width, height, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
        ...
        public void ComputeGeneratedTexture()
        {
            ...
            Assert.Equal(RgbaFloat.BLACK, readView[2, 0]);
        ...
        public void SampleTexture1D(bool arrayTexture)
        {
            ...
            Texture tex1D = RF.CreateTexture(
                TextureDescription.Texture1D(128, 1, layers, PixelFormat.R32G32B32A32Float, TextureUsage.Sampled));
        ...
        public void BindTextureAcrossMultipleDrawCalls()
        {
            ...
            Texture target2 = RF.CreateTexture(TextureDescription.Texture2D(
                50, 50, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget | TextureUsage.Sampled));
            ...
            ShaderSetDescription quadShaderSet = new ShaderSetDescription(
                ...
                {
                    new VertexLayoutDescription(
                        new VertexElementDescription("AV3", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float3),
                        new VertexElementDescription("BV4", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float4),
                        new VertexElementDescription("CV2", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float2),
                        new VertexElementDescription("DV4", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float4)
                    )
                },
        ...
        {
            Texture target = RF.CreateTexture(TextureDescription.Texture2D(
                16, 16, 1, layerCount, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            ...
            Texture tex2D = RF.CreateTexture(
                TextureDescription.Texture2D(128, 128, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.Sampled));
        ...
        public void WriteFragmentDepth()
        {
            Texture depthTarget = RF.CreateTexture(
                TextureDescription.Texture2D(64, 64, 1, 1, PixelFormat.R32Float, TextureUsage.DepthStencil | TextureUsage.Sampled));
        ...
        {
            Texture output = RF.CreateTexture(
                TextureDescription.Texture2D(64, 64, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            using var framebuffer = RF.CreateFramebuffer(new FramebufferDescription(null, output));
