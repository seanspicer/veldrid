...
namespace Veldrid.Tests
{
    ...
    {
        [Fact]
        public void NoDepthTargetClearAllColorsSucceeds()
        {
            Texture colorTarget = RF.CreateTexture(
                TextureDescription.Texture2D(1024, 1024, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
        ...
        [Fact]
        public void NoDepthTargetClearDepthFails()
        {
            Texture colorTarget = RF.CreateTexture(
                TextureDescription.Texture2D(1024, 1024, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            Framebuffer fb = RF.CreateFramebuffer(new FramebufferDescription(null, colorTarget));
        ...
        [Fact]
        public void NoColorTargetClearColorFails()
        {
            Texture depthTarget = RF.CreateTexture(
                TextureDescription.Texture2D(1024, 1024, 1, 1, PixelFormat.R16UNorm, TextureUsage.DepthStencil));
        ...
        [Fact]
        public void ClearColorTargetOutOfRangeFails()
        {
            TextureDescription desc = TextureDescription.Texture2D(
                1024, 1024, 1, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget);
        ...
        [Fact]
        public void NonZeroMipLevelClearColorSucceeds()
        {
            Texture testTex = RF.CreateTexture(
                TextureDescription.Texture2D(1024, 1024, 11, 1, PixelFormat.R32G32B32A32Float, TextureUsage.RenderTarget));
            ...
            Texture readback = RF.CreateTexture(
                TextureDescription.Texture2D(1024, 1024, 11, 1, PixelFormat.R32G32B32A32Float, TextureUsage.Staging));
            cl.Begin();
    ...
    {
        [Fact]
        public void ClearSwapchainFramebufferSucceeds()
        {
            CommandList cl = RF.CreateCommandList();
            cl.Begin();
